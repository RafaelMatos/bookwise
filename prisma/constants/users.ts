...
export const users = [
  {
    ...
    name: 'Jaxson Dias',
    email: faker.internet.email({ firstName: 'Jaxson Dias' }),
    avatar_url:
  ...
  },
  {
    ...
    name: 'Brandon Botosh',
    email: faker.internet.email({ firstName: 'Brandon Botosh' }),
    avatar_url:
  ...
  },
  {
    ...
    email: faker.internet.email({ firstName: 'Lindsey Philips' }),
    avatar_url:
  ...
  },
  {
    ...
    name: 'Jaylon Franci',
    email: faker.internet.email({ firstName: 'Jaylon Franci' }),
    avatar_url:
